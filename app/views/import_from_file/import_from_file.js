...
angular.module('console.import_from_file', [{
    ...
    .controller('ImportFromFileCtrl', ['$rootScope', '$scope', '$timeout', 'project',
        function($rootScope, $scope, $timeout, project) {
            ...
            $scope.$onInit = function() {
                ctrl.alerts = {};
                // console.log('ctrl.loginBaseUrl', DataService.openshiftAPIBaseUrl())
                ctrl.loginBaseUrl = 'https://new.dataos.io:8443';
            ...
            $scope.$on('templateInstantiated', function(event, message) {
                ...
                ctrl.name = "99999" //$filter('displayName')(ctrl.template);
