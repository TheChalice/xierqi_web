...
angular.module('console.pipeline', [
        {
            files: [
                'components/searchbar/searchbar.js',
                'views/pipeline/pipeline.css'
            ]
        }
    ])
    .controller('PipelineCtrl', ['$rootScope', '$scope', '$log', '$state', '$stateParams', 'BuildConfig', 'Build', 'GLOBAL', 'Confirm', 'Sort', 'Ws',
